...
('Анализ скульптур и объектов', 
    'Профессиональное исследование объемно-пространственных произведений искусства. Определяем композиционный центр, анализируем пластическую выразительность формы и оцениваем перспективное восприятие объекта в окружающей среде.', 
    true, 
